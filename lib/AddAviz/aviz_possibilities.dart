...
class AvizPossibilities extends StatefulWidget {
  const AvizPossibilities({super.key});
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Column(
                      children: [
                        possibilitiesItems("آسانسور", true),
                        possibilitiesItems("پارکینگ", false),
                        possibilitiesItems("انباری", true),
                      ],
                    ),
                    ElevatedButton(
...
Widget possibilitiesItems(String text, bool active) {
  return Container(
    width: 343,
    height: 48,
    ...
    child: Row(
      ...
      children: [
        Padding(
          ...
          child: Icon(
            active ? Iconsax.toggle_on_circle5 : Iconsax.toggle_off_circle,
            color: active ? red : grey3,
            size: 24,
          ),
        ),
        Padding(
