import 'package:aviz/AddAviz/get_information.dart';
...
class AvizPossibilitiesScreen extends StatefulWidget {
  const AvizPossibilitiesScreen({super.key, required this.subCategory});
  final List<String> subCategory;
  @override
  State<AvizPossibilitiesScreen> createState() =>
      _AvizPossibilitiesScreenState();
}

class _AvizPossibilitiesScreenState extends State<AvizPossibilitiesScreen> {
  String category = "";
