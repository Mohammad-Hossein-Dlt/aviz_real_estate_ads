...
class SavedAvizScreen extends StatefulWidget {
  const SavedAvizScreen({super.key});

  @override
  State<SavedAvizScreen> createState() => _SavedAvizScreenState();
}

class _SavedAvizScreenState extends State<SavedAvizScreen> {
